...
test("DatabaseListOptions will create buttons for loading and adding databases", () => {
...
test("DatabaseListOptions will disable it's load database button, if selected index is less than 0", () => {
...
test("DatabaseListOptions will run the function passed as the loadSelectedDatabase prop when the load button is pressed", () => {
