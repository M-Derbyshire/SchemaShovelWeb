...
public class ColumnDescriptionControllerValidationTests {
	...
	void updateWithDescAsNullWillReturnValidationError() throws Exception {
		...
		String columnJSON = "{ \"description\": null, \"id\": 1 }";
		
		mockMvc.perform(MockMvcRequestBuilders.patch("/api/v1/columns/update_description/1")
			.content(columnJSON)
