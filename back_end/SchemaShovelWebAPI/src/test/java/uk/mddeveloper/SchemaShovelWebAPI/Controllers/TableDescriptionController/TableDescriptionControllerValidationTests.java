...
public class TableDescriptionControllerValidationTests {
	...
	void updateWithDescAsNullWillReturnValidationError() throws Exception {
		...
		String tableJSON = "{ \"description\": null, \"id\": 1 }";
		
		mockMvc.perform(MockMvcRequestBuilders.patch("/api/v1/tables/update_description/1")
			.content(tableJSON)
